...
rule tbprofiler_depth:
    ...
    params:
        ...
        min_depth=lambda wildcards: 10 if int(wildcards.depth) > 20 else 1,
...
rule drprg_depth:
    ...
    params:
        ...
        filters=lambda wildcards: drprg_filter_args(wildcards, None if int(wildcards.depth) > 20 else 1),
